...
function equationGenerator(firstOp = getRndInteger(firstOpMin, firstOpMax),
                            secondOp = getRndInteger(secondOpMin, secondOpMax),
                            result = getRndInteger(firstOpMin + secondOpMin, firstOpMax + firstOpMax)){  
...
function quiz(){
    ...
    document.getElementById("C1").style.backgroundColor = "#d0dde69a";
    document.getElementById("C2").style.backgroundColor = "#d0dde69a";
    document.getElementById("C3").style.backgroundColor = "#d0dde69a";
...
function saveResult(){
    ...
    sumOnesRes[sumOnesRes.length - 1] = correctAnswerCounter;
